...
function Search() {
            ...
            <a href={item.link}>
              <Box sx={{ display: "flex", alignItems: "center" }}>
                <span className="w-32">
                  ...
                  {/* <Image src={item.img} alt={item.name}  width={128} height={128}/>  */}
                  {/* for some reason it throws an error so i mean fuck it */}
                </span>
    ...
    return (
      <>
        ...
        <Typography variant="h4" color="white">
          Parsing data takes between 5 and 15 seconds
        </Typography>
  ...
  return (
    <>
      <Head>
        <title>
          hello tummy {query.search ? "| " + query.search : "sadge"}
        </title>
